...
# Set up credentials
TELEGRAM_BOT_TOKEN = '6564144223:AAGjuUsliQo6uHpRQByeqBupRxP84CZbSmM'
GRAPH_CLIENT_ID = '59790544-ca0c-4b77-b338-26ff9d1b676f'
GRAPH_TENANT_ID = '0fd666e8-0b3d-41ea-a5ef-1c509130bd94'
...
def generate_all_file_links(folder_id, access_token, user_id):
    """Generates a message with all the file links in the folder."""
    files = get_files(access_token, folder_id)
    if files:
        links = []
        for file in files:
...
def generate_navigation_buttons(folder_id, page, access_token):
    """Generates the navigation buttons for file browsing."""
    files = get_files(access_token, folder_id)
